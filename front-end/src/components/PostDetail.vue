        ...
        <article class="g-mb-60 g-pt-15 g-pb-50">
          <header class="g-mb-30">
            ...
            <ul class="list-inline d-sm-flex g-color-gray-dark-v4 mb-0">
              ...
              <li v-if="post.author" class="list-inline-item">
                <router-link v-bind:to="{ path: `/user/${post.author.id}` }" class="u-link-v5 g-color-gray-dark-v4 g-color-primary--hover g-text-underline--none--hover">
          ...
          <div id="postBody" class="g-font-size-16 g-line-height-1_8 g-mb-30">
            ...
            <vue-markdown
              ...
              toc-id="toc"
              class="markdown-body"></vue-markdown>
          </div>
        </article>
...
<!--        pre/next-->
        <div class="g-mb-60">
          <ul class="list-inline d-sm-flex mb-0">
            <li v-bind:class="{'u-pagination-v1__item--disabled': !post.prev_id}" class="list-inline-item g-hidden-xs-down"
                data-toggle="tooltip" data-placement="top" title="" v-bind:data-original-title="post.prev_title || ''">
              <router-link v-bind:to="{name: 'PostDetail', params: {id:post.prev_id||0}}"
                           class="u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-color-primary--hover g-rounded-50 g-pa-7-16" href="#" aria-label="Previous">
            ...
            <li v-bind:class="{'u-pagination-v1__item--disabled': !post.next_id}" class="list-inline-item ml-auto g-hidden-xs-down"
                data-toggle="tooltip" data-placement="top" title="" v-bind:data-original-title="post.next_title || ''">
              <router-link router-link v-bind:to="{ name: 'PostDetail', params: { id: post.next_id || 0 } }"
                           class="u-pagination-v1__item u-pagination-v1-4 g-brd-gray-light-v3 g-brd-primary--hover g-rounded-50 g-pa-7-16" href="#" aria-label="Next">
                <span aria-hidden="true">
            ...
            <div v-for="(comment, index) in comments.items" v-bind:key="index">
              <div v-bind:id="'c'+comment.id" class="comment-item media g-brd-around g-brd-gray-light-v4 g-pa-30 g-mb-20">
                ...
                <div class="media-body">
                  <div class="g-mb-15">
                    <h5 v-if="comment.author.id == comment.post.author_id" class="h5 g-color-gray-light-v1 mb-0">
                      <router-link v-bind:to="{path:`/user/${comment.author.id}`}" class="comment-author g-text-underline--none--hover">
      ...
      methods:{
        ...
        onDeletePost(post){
            this.$swal({
              ...
              confirmButtonText:'Ues, delete it!',
              ...
              if(result.value){
                ...
                this.$axios.delete(path)
                  .then((response)=>{
                    this.$swal('Deleted','you successfully delete this post','success')
