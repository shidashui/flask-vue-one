<template>
  <div>
    ...
    <h4 v-if="user.location" class="h6 g-font-weight-300 g-mb-10">
      <i class="icon-location-pin g-pos-rel g-top-1 g-color-gray-dark-v5 g-mr-5"></i> <a v-bind:href="'https://www.amap.com/search?query='+user.location" target="_blank">{{ user.location }}</a>
    </h4>
    <!-- End Location -->
