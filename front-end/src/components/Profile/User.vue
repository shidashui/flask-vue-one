...
<!--             Actions-->
             ...
             <button v-if="$route.params.id != sharedState.user_id" class="btn btn-block u-btn-outline-aqua g-rounded-50 g-py-12 g-mb-10"
             ...
             <ul class="nav nav-tabs g-mb-20">
               ...
               <li class="nav-item">
                 <router-link v-bind:to="{name:'UserFollowers'}" v-bind:active-class="'active'" class="nav-link">
                   Followers <span class="u-label g-font-size-11 g-bg-deeporange g-rounded-20 g-px-10">{{user.followers_count}}</span>
                 </router-link>
               </li>
               <li class="nav-item">
               ...
               <li class="nav-item">
                 <router-link v-bind:to="{ name: 'UserPosts' }" v-bind:active-class="'active'" class="nav-link" v-bind:class="{'active': $route.name == 'UserFollowingPosts'}">
